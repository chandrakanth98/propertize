...
class MaintenanceRequestTable(tables.Table):
    ...
    full_name = tables.Column(verbose_name='Full Name', accessor='submitted_by', order_by=(
    ...
    open = tables.TemplateColumn(
        "<a class='text-dark profile-btn' href='{% url 'maintenance_request' request_id=record.request_id %}'><i class='fa fa-cog'></i></a>", verbose_name='')
